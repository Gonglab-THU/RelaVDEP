...
import sys
sys.path.append('..')
from SPIRED_Fitness.models import *
from relavdep.modules.utils._models import *
from relavdep.modules.utils._functions import *

parser = argparse.ArgumentParser(description='Predict ΔΔG and ΔTm of candidate mutants')
...
assert os.path.exists(args.library), "!!! Mutants data does not exist !!!"
