...
All sequence embeddings of ProteinGym DMS assays (`embeddings.zip`) can be downloaded from [Zenodo](https://zenodo.org/records/17590929/files/embeddings.zip?download=1). The full zip archive takes up approximately 34.2GB of storage.
